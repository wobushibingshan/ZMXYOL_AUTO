...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        default=["assets/resource/base/pipeline"],
        help=(
            "Directories containing pipeline files to validate "
            "(default: assets/resource/base/pipeline)"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            "Directories containing task files to validate against "
            "interface_import.schema.json (default: assets/resource/tasks)"
        ),
    )
